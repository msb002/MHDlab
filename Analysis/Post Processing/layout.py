...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_parse_int = QtWidgets.QPushButton(self.centralwidget)
        self.btn_parse_int.setGeometry(QtCore.QRect(330, 420, 111, 28))
        self.btn_parse_int.setObjectName("btn_parse_int")
        ...
        self.folderEdit.setGeometry(QtCore.QRect(100, 450, 211, 22))
        self.folderEdit.setObjectName("folderEdit")
        self.filenameEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.filenameEdit.setGeometry(QtCore.QRect(100, 480, 211, 22))
        ...
        self.btn_parse_ext = QtWidgets.QPushButton(self.centralwidget)
        self.btn_parse_ext.setGeometry(QtCore.QRect(330, 450, 111, 28))
        self.btn_parse_ext.setObjectName("btn_parse_ext")
        self.btn_parse_tci = QtWidgets.QPushButton(self.centralwidget)
        self.btn_parse_tci.setGeometry(QtCore.QRect(330, 480, 111, 28))
        self.btn_parse_tci.setObjectName("btn_parse_tci")
        self.combo_routines = QtWidgets.QComboBox(self.centralwidget)
        self.combo_routines.setGeometry(QtCore.QRect(30, 530, 81, 22))
        self.combo_routines.setObjectName("combo_routines")
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(30, 510, 55, 16))
        self.label_13.setObjectName("label_13")
        self.label_14 = QtWidgets.QLabel(self.centralwidget)
        self.label_14.setGeometry(QtCore.QRect(120, 510, 55, 16))
        self.label_14.setObjectName("label_14")
        self.combo_files = QtWidgets.QComboBox(self.centralwidget)
        self.combo_files.setGeometry(QtCore.QRect(120, 530, 81, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_parse_int.setText(_translate("MainWindow", "Parse internal file"))
        ...
        self.btn_parse_ext.setText(_translate("MainWindow", "Parse other file"))
        self.btn_parse_tci.setText(_translate("MainWindow", "Parse TCI"))
        self.label_13.setText(_translate("MainWindow", "routine"))
        ...
        self.combo_times.setItemText(0, _translate("MainWindow", "Eventlog"))
